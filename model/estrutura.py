...
class Estrutura():
    ...
    @property
    def table_amount(self):
        return self._qtd_mesas

    @table_amount.setter
    def table_amount(self, value):
        self._qtd_mesas = value

    @table_amount.deleter
    def table_amount(self):
        del self._qtd_mesas
    ...
    def calculate(self):
        self.tam_tot = ((self.module.length*self.module_amount)-21+(7*self.module_amount))/3; 'Largura total da mesa em [mm]'
